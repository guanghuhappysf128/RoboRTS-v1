...
void SerialComNode::Run(char* comm) {
  printf("This is the commond string: |%s| \n",comm);
  if (comm==NULL)
  {
    comm = (char*)"default";
  }
...
tx_buf_[8]=0x12;
//total_length_=9;
  sub_cmd_gim_ = nh_.subscribe("enemy_pos", 1, &SerialComNode::GimbalRelativeControlCallback, this);
...
else if (strcmp(comm,"relax")==0){
//GimbalRelax();
}
else if (strcmp(comm,"shoot1")==0){
//ShootingTest(1);
}
else if (strcmp(comm,"shoot2")==0){
//ShootingTest(2);
}
// spin mode
else if (strcmp(comm, "xuan")==0){
//ChassisXuan();
}
else {
...
void SerialComNode::CaliStart() {

    uint8_t pack[PACK_MAX_SIZE];
 CalibrateCommand comm;
comm.type=1; 
    int length = sizeof(CalibrateCommand), pack_length = length + HEADER_LEN + CMD_LEN + CRC_LEN;
    SendDataHandle(CALI_GIMBAL_ID, (uint8_t *) &comm, pack, length);
    ...
    printf("Cali start sent!\n");


}
void SerialComNode::CaliStop() {
...
//printf("is open: %d, stop: %d,rosok: %d\n",is_open_,stop_receive_,ros::ok());
...
// printf("\n\n\nThis is chassis information:\n");
// printf("chassis_information_.gyro_palstance: %f\n",chassis_information_.gyro_palstance);
// printf("chassis_information_.gyro_angle: %f\n",chassis_information_.gyro_angle);
// printf("chassis_information_.ecd_palstance: %f\n",chassis_information_.ecd_palstance);
// printf("chassis_information_.ecd_angle: %f\n",chassis_information_.ecd_angle);
// printf("chassis_information_.x_speed: %d\n",chassis_information_.x_speed);
// printf("chassis_information_.y_speed: %d\n",chassis_information_.y_speed);
// printf("chassis_information_.x_position: %d\n",chassis_information_.x_position);
// printf("chassis_information_.y_position: %d\n",chassis_information_.y_position);
...
// printf("\n\n\n\n\nThis is gimbal information:\n");
// printf("gimbal_information_.pit_relative_angle: %f\n",gimbal_information_.pit_relative_angle);
// printf("gimbal_information_.yaw_relative_angle: %f\n",gimbal_information_.yaw_relative_angle);
// printf("gimbal_information_.pit_absolute_angle: %f\n",gimbal_information_.pit_absolute_angle);
// printf("gimbal_information_.yaw_absolute_angle: %f\n",gimbal_information_.yaw_absolute_angle);
// printf("gimbal_information_.pit_palstance: %f\n",gimbal_information_.pit_palstance);
// printf("gimbal_information_.yaw_palstance: %f\n",gimbal_information_.yaw_palstance);
	...
	printf("%dth Entry on error list is %d\n", i, global_error_data_.err[i]);
...
int main(int argc, char **argv){
  ...
  ros::init(argc, argv, "test_serial", ros::init_options::NoSigintHandler);

  rrts::driver::serial::SerialComNode rrts("test_serial");
